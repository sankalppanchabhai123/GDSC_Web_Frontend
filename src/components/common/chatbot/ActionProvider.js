...
class ActionProvider {
  ...
  handle = () => {
    const botMessage = this.createChatBotMessage("GDGC leads who are chosen by google itself handle and manage the club with the help of other team members(leads) and faculties.");
    this.addmessagetostate(botMessage);
  };

  who = () => {
    const botMessage = this.createChatBotMessage("College and university students are encouraged to join Google Developer Group On Campus.\n One can be a part of GDGC in different ways",
      {
  ...
  who_btn = () => {
    const chatmessge = createClientMessage("How to join the club GDGC?")
    const botMessage = this.createChatBotMessage("College and university students are encouraged to join Google Developer Group On Campus.\n One can be a part of GDGC in different ways",
      {
        widget: 'differentpeople',
      }
  ...
  ques2 = () => {
    const botMessage = this.createChatBotMessage(
      "You can participate in events organized by multiple chapters, however if you decide to dedicate yourself to become a GDGC Lead or Core Team Member, you will be officially assigned to one chapter."
    );
    this.addmessagetostate(botMessage);
  };
  ...
  def = () => {
    const botMessage = this.createChatBotMessage(
      "Google Developer Group On Campus (GDGC) are like your college/ university clubs, powered by Google Developers. Every year, Google selects leads from across the globe who align with the vision of GDGC and want to empower their community. This year, there are around 352 leads selected across India."
    );
    this.addmessagetostate(botMessage);
  };
  ...
  def_btn = () => {
    const chatmsg = createClientMessage("What is GDGC?");
    const botMessage = this.createChatBotMessage(
      "Google Developer Group On Campus (GDGC) are like your college/ university clubs, powered by Google Developers. Every year, Google selects leads from across the globe who align with the vision of GDGC and want to empower their community. This year, there are around 352 leads selected across India."
    );
    this.addmessagetostate(chatmsg);
  ...
  leadwork = () => {
    console.log("here");
    const botMessage0 = this.createChatBotMessage("In general, GDGC leaders are focused on the following areas:");
  ...
  workshop = () => {
    const botMessage = this.createChatBotMessage(
      "Hosting workshops is a great way to engage members and provide value to your GDGC club community."
    );
    const botMessage1 = this.createChatBotMessage(
  ...
  project = () => {
    ...
    const botMessage3 = this.createChatBotMessage(
      "3. Recruit a team of fellow GDGC members who have the necessary skills and are interested in working on the project. "
    );
    const botMessage4 = this.createChatBotMessage(
  ...
  collab = () => {
    const botMessage = this.createChatBotMessage("1. Identify potential GDGC clubs to collaborate with. You can start by checking the GDGC website or social media pages.");
  ...
  collab_btn = () => {
    const chatmsg = createClientMessage("How to collab with other GDGC clubs?");
    const botMessage = this.createChatBotMessage("1. Identify potential GDGC clubs to collaborate with. You can start by checking the GDGC website or social media pages.");
    const botMessage1 = this.createChatBotMessage("2. Once you have established contact with the other club, discuss potential ideas for collaboration. You can brainstorm project ideas or events that you can work on together.");
    const botMessage3 = this.createChatBotMessage("3.  With a plan in place, it's time to execute the collaboration. Make sure to communicate regularly with the other club during the project or event to ensure that everything is on track.");
    const botMessage4 = this.createChatBotMessage("4. Once the collaboration is complete, take the time to celebrate the success of the project or event with the other club. ");
  ...
  join_faculty = () => {
    const botMessage = this.createChatBotMessage(
      "Visit GDGC website (https://developers.google\n.com/community/GDGC/)\n Find the GDGC near you, contact the GDGC lead from their contact information on the GDGC website or social media pages."
    );
    const botMessage1 = this.createChatBotMessage(
      "Ask the GDGC lead if you can attend one of their meetings to get a sense of their activities and how they work.\n Once you have joined the GDGC, participate in their activities and contribute to their projects. This can be in the form of mentorship, guidance, or helping with events and workshops. "
    );
    this.addmessagetostate(botMessage);
    this.addmessagetostate(botMessage1);
  };
  ...
  join_faculty_btn = () => {
    const chatmsg = createClientMessage("How to join GDGC as a Faculty member?");
    const botMessage = this.createChatBotMessage(
      "Visit GDGC website (https://developers.google\n.com/community/GDGC/)\n Find the GDGC near you, contact the GDGC lead from their contact information on the GDGC website or social media pages."
    );
    const botMessage1 = this.createChatBotMessage(
  ...
  join_lead = () => {
    const botMessage = this.createChatBotMessage(
      "The first step is to join a GDGC as a member. Attend their meetings, participate in their events and projects, and get to know the current leadership team and other members."
    );
    const botMessage1 = this.createChatBotMessage(
    ...
    const botMessage2 = this.createChatBotMessage(
      "When the opportunity arises, apply for the position of GDGC lead or specialist. This may involve submitting an application, attending an interview, or presenting your ideas and plans for the club."
    );
    const botMessage3 = this.createChatBotMessage(
      "If you are selected as a GDGC lead or specialist, attend the training provided by Google to develop the necessary skills and knowledge to effectively lead the club. The lead is directly selected by google while the lead interviews the rest of the specialists"
    );
    this.addmessagetostate(botMessage);
    this.addmessagetostate(botMessage1);
    this.addmessagetostate(botMessage2);
  ...
  join_lead_btn = () => {
    const chatmsg = createClientMessage("How to join GDGC as a Lead?");
    const botMessage = this.createChatBotMessage(
      "The first step is to join a GDGC as a member. Attend their meetings, participate in their events and projects, and get to know the current leadership team and other members."
    );
    const botMessage1 = this.createChatBotMessage(
  ...
  join_coordinator_btn = () => {
    const chatmsg = createClientMessage("How to join GDGC as a coordinator in some field?");
    const botMessage = this.createChatBotMessage(
      "The first step is to join a GDGC as a member. Attend their meetings, participate in their events and projects, and get to know the current leadership team and other members."
    );
    const botMessage1 = this.createChatBotMessage(
  ...
  join_member = () => {
    const botMessage = this.createChatBotMessage(
      "Find a GDGC near you: Visit the GDGC website https://developers.google\n.com/community/GDGC/ and search for a GDGC in your area. You can also check with your university or college to see if they have a GDGC on campus."
    );
    const botMessage1 = this.createChatBotMessage(
      " Look for events or meetings hosted by the GDGC and attend them. This will give you an opportunity to meet the members and learn more about the club and its activities.\nAs a GDGC member, participate in the club's events, workshops, and projects. This will help you develop your skills and learn new technologies while also building relationships with other members."
    );
    this.addmessagetostate(botMessage);
    this.addmessagetostate(botMessage1);
  };
  ...
  join_member_btn = () => {
    const chatmsg = createClientMessage("How to participate in GDGC as a member/volunteer?");
    const botMessage = this.createChatBotMessage(
      "Find a GDGC near you: Visit the GDGC website https://developers.google\n.com/community/GDGC/ and search for a GDGC in your area. You can also check with your university or college to see if they have a GDGC on campus."
    );
    const botMessage1 = this.createChatBotMessage(
  ...
  time = () => {
    const botMessage = this.createChatBotMessage("GDGC Leads should be available to run an event ideally once a month, and at least every three months to remain an active GDGC chapter. Additionally, running a GDGC is a one year commitment."
    );
    this.addmessagetostate(botMessage);
  };

  past_events = () => {
    const botMessage = this.createChatBotMessage("Some of the events held by GDGC of our college are:"
    );
  ...
  register = () => {
    const botMessage = this.createChatBotMessage("You can directly be a part of any event conducted by GDGC just by clicking on RSVP and filling your details. You will then receive a confirmation mail on the given mailid."
    );
    this.addmessagetostate(botMessage);
  };
  ...
  whyGDGC = () => {
    const botMessage = this.createChatBotMessage("Joining a GDGC chapter can provide several benefits, including:"
    );
    const botMessage1 = this.createChatBotMessage("1. GDGCs offer a variety of workshops, events, and activities that can help you develop your technical and professional skills, opportunity to learn about Google technologies and other tools used in the industry.");
    const botMessage2 = this.createChatBotMessage("2. GDGCs provide a great way to meet other students who share your interests in technology and connect with professionals in the tech industry. You'll be able to build your network and gain valuable contacts for future job opportunities.");
    const botMessage3 = this.createChatBotMessage("3. GDGCs often offer opportunities to work on real-world projects, participate in hackathons, and attend industry events. ");
    const botMessage4 = this.createChatBotMessage("4. GDGCs have access to resources provided by Google, including training materials, development tools, and other resources that can be useful in your studies and future career.");
    const botMessage5 = this.createChatBotMessage("5. GDGCs are run by student leaders, which means you'll have the opportunity to develop your leadership skills by organizing events and activities for the club.");
    this.addmessagetostate(botMessage);
    this.addmessagetostate(botMessage1);
    this.addmessagetostate(botMessage2);
    this.addmessagetostate(botMessage3);
  ...
  whyGDGC_btn = () => {
    const chatmsg = createClientMessage("Why should I join GDGC?");
    const botMessage = this.createChatBotMessage("Joining a GDGC chapter can provide several benefits, including:"
    );
    const botMessage1 = this.createChatBotMessage("1. GDGCs offer a variety of workshops, events, and activities that can help you develop your technical and professional skills, opportunity to learn about Google technologies and other tools used in the industry.");
    const botMessage2 = this.createChatBotMessage("2. GDGCs provide a great way to meet other students who share your interests in technology and connect with professionals in the tech industry. You'll be able to build your network and gain valuable contacts for future job opportunities.");
